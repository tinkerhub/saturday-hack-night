...
const faqs = [
  {
    ...
    answer:
      "Saturday Hack Night is bi-weekly hackathon that gives tech-savvy learners an opportunity to explore all the latest technology related concepts including APIs, frameworks and build some cool projects.",
  },
  {
    question: "Who can Participate?",
    answer:
      "Anyone who is interested in learning and building something new. You can be a student, a professional, or a hobbyist. All you need is a laptop and an internet connection.",
  },
  {
    question: "What should be the team size?",
    answer:
      "A Team should have minimum 2 Members & can be a maximum of 4 Member.",
  },
  {
  ...
  },
  {
    ...
    answer:
      " The program will be conducted on every odd Saturday from 06:00 PM to 11:00 PM IST.",
  },
  {
    ...
    <>
      ...
      >
        ...
        <Container maxW="720px">
          ...
          >
            It’s a bi weekly hackathon that gives tech-savvy learners an
            oppurtunity to explore all the latest technology related concepts
          ...
          >
            ...
            >
              ...
              <Text
                ...
                marginBlock="18px"
              >
                Saturday HackNight is a platform for tech enthusiasts to explore
                the latest technology-related concepts, collaborate with others
                to develop their ideas and projects, and stay up-to-date on the
                latest tech trends.
              </Text>
            </VStack>
            <Image
      ...
      <VStack alignItems="center" justifyContent="center" marginBlock="16px">
        ...
        >
          ...
          <Link href="https://www.instagram.com/fof_kochi/">
            <Image
              src="/images/partners/fof_kochi.png"
              alt="Friends of Figma Kochi"
            />
          </Link>
        </Flex>
      </VStack>
