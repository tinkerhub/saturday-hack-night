    ...
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      ...
      >
        ...
        >
          ...
          {current === index && (
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2  translate-y-56 md:translate-y-32 bg-white/70 backdrop-blur-sm p-4 sm:p-6 rounded-3xl text-black w-[300px] md:w-[600px] md:h-[100px]  h-[100px] flex flex-col items-start justify-between">
