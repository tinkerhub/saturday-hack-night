      ...
      <div className="max-w-4xl mx-auto translate-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {partnerImages.map((image, index) => (
            ...
            >
              <div className="relative aspect-square w-full max-w-[200px] mx-auto overflow-hidden rounded-xl border border-[#0A0A0F]/10 shadow-lg shadow-[#0A0A0F]/20 hover:shadow-[#0A0A0F]/30">
                <img 
                  src={image}
                  alt={`Partner ${index + 1}`}
