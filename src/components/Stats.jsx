    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 p-4 sm:p-6 md:p-8">
      <div className=" rounded-lg p-3 sm:p-4 md:p-6">
        <div className="text-center">
          <h3 className="text-2xl sm:text-4xl md:text-6xl font-clash font-bold mb-2 sm:mb-4">1600+</h3>
      ...
      <div className="rounded-lg p-3 sm:p-4 md:p-6">
        <div className="text-center">
          <h3 className="text-2xl sm:text-4xl md:text-6xl font-clash font-bold mb-2 sm:mb-4">400+</h3>
      ...
      <div className="rounded-lg p-3 sm:p-4 md:p-6">
        <div className="text-center">
          <h3 className="text-2xl sm:text-4xl md:text-6xl font-clash font-bold mb-2 sm:mb-4">45+</h3>
      ...
      <div className="rounded-lg p-3 sm:p-4 md:p-6">
        <div className="text-center">
          <h3 className="text-2xl sm:text-4xl md:text-6xl font-clash font-bold mb-2 sm:mb-4">5</h3>
