...
export default function ConnectedScrollPage() {
  ...
  return (
    <div className="w-screen md:-translate-x-52 text-white min-h-screen">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div ref={observerRef} className="relative">
          
          {/* Fixed center line with moving dot */}
          <div className="fixed left-1/2 top-1/2  transform md:-translate-x-1/2 -translate-x-72 -translate-y-1/2 pointer-events-none z-10">
            {/* Vertical line */}
            ...
            {items.map((item, index) => (
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full max-w-6xl">
                  ...
                  <div className="  md:translate-x-0 lg:text-right">
                    <div className={`
                  ...
                  {/* Content - right side */}
                  <div className={`
                    transition-all duration-700  md:translate-x-0 lg:text-left
                    ${activeIndex === index 
                  ...
                  `}>
                    ...
                    <p className="text-lg  lg:text-xl leading-relaxed font-light max-w-sm md:max-w-2xl">
                      {item.content}
                    </p>
